...
class Config(object):
    ...
    API_ID = int(os.environ.get("API_ID", "1627187"))
    API_HASH = os.environ.get("API_HASH","5b107c23489481922b596a5ebe23080a")
    ...
    # your telegram id
    OWNER_ID = int(os.environ.get("OWNER_ID", "141908005"))
